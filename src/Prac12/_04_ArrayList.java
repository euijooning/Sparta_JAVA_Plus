...
public class _04_ArrayList {
    // 컬랙션 프레임워크. 많은 데이터를 효과적으로 관리하기 위해서 자바가 제공하는 도구
    // List, Set, Map
    public static void main(String[] args) {
        ...
        list.remove("박명수"); // 괄호 안에 데이터를 그대로 적어주면 됨.
        System.out.println("신청 학생 수 (철회 후) : " + list.size());

        System.out.println(list.get(3)); // 강호동 씨가 올라온 것을 알 수 있음.
        ...
        System.out.println(list.indexOf("김종국")); // 괄호 안에 찾으려는 데이터를 넣어주면 된다.
